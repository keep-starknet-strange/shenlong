...
jump_dest:                                        ; preds = %dest1
  %15 = call i252 @"rename<felt>"(i252 %14)
  %ret_struct_ptr4 = alloca { i252 }, align 8
  %field_0_ptr5 = getelementptr inbounds { i252 }, ptr %ret_struct_ptr4, i32 0, i32 0
  store i252 %15, ptr %field_0_ptr5, align 4
  %return_struct_value6 = load { i252 }, ptr %ret_struct_ptr4, align 4
  ret { i252 } %return_struct_value6
}
...
entry:
  ...
  store { i252 } %6, ptr %res_ptr, align 4
  %"3_ptr" = getelementptr inbounds { i252 }, ptr %res_ptr, i32 0, i32 0
  %"3" = load i252, ptr %"3_ptr", align 4
