...
define i253 @"felt_const<0>"() !dbg !54 {
entry:
  ret i253 0, !dbg !55
}

define i253 @"felt_const<30>"() !dbg !56 {
entry:
  ret i253 30, !dbg !57
}

define i253 @"fib_box::fib_box::fib"(i253 %0, i253 %1, i253 %2) !dbg !58 {
entry:
  %3 = call i253 @"unbox<felt>"(i253 %2), !dbg !61
  %4 = call i253 @"store_temp<felt>"(i253 %3), !dbg !61
  %5 = call { i253, i253 } @"dup<felt>"(i253 %4), !dbg !61
  %res_ptr = alloca { i253, i253 }, align 8, !dbg !61
  store { i253, i253 } %5, ptr %res_ptr, align 4, !dbg !61
  %"3_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr, i32 0, i32 0, !dbg !61
  %"3" = load i253, ptr %"3_ptr", align 4, !dbg !61
  %"5_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr, i32 0, i32 1, !dbg !61
  %"5" = load i253, ptr %"5_ptr", align 4, !dbg !61
  %check = icmp eq i253 %"5", 0, !dbg !61
  br i1 %check, label %then, label %else, !dbg !61

then:                                             ; preds = %entry
  %6 = call i253 @"store_temp<Box<felt>>"(i253 %0), !dbg !61
  br label %dest, !dbg !61

else:                                             ; preds = %entry
  br label %dest1, !dbg !61

dest:                                             ; preds = %then
  %7 = call i253 @"rename<Box<felt>>"(i253 %6), !dbg !61
  ret i253 %7, !dbg !61

dest1:                                            ; preds = %else
  %8 = call i253 @"unbox<felt>"(i253 %0), !dbg !61
  %9 = call { i253, i253 } @"dup<Box<felt>>"(i253 %1), !dbg !61
  %res_ptr2 = alloca { i253, i253 }, align 8, !dbg !61
  store { i253, i253 } %9, ptr %res_ptr2, align 4, !dbg !61
  %"1_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr2, i32 0, i32 0, !dbg !61
  %"1" = load i253, ptr %"1_ptr", align 4, !dbg !61
  %"9_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr2, i32 0, i32 1, !dbg !61
  %"9" = load i253, ptr %"9_ptr", align 4, !dbg !61
  %10 = call i253 @"unbox<felt>"(i253 %"9"), !dbg !61
  %11 = call i253 @"store_temp<felt>"(i253 %8), !dbg !61
  %12 = call i253 @"store_temp<felt>"(i253 %10), !dbg !61
  %13 = call i253 @felt_add(i253 %11, i253 %12), !dbg !61
  %14 = call i253 @"store_temp<felt>"(i253 %13), !dbg !61
  %15 = call i253 @"into_box<felt>"(i253 %14), !dbg !61
  %16 = call i253 @"felt_const<1>"(), !dbg !61
  %17 = call i253 @felt_sub(i253 %"3", i253 %16), !dbg !61
  %18 = call i253 @"store_temp<felt>"(i253 %17), !dbg !61
  %19 = call i253 @"into_box<felt>"(i253 %18), !dbg !61
  %20 = call i253 @"store_temp<Box<felt>>"(i253 %"1"), !dbg !61
  %21 = call i253 @"store_temp<Box<felt>>"(i253 %15), !dbg !61
  %22 = call i253 @"store_temp<Box<felt>>"(i253 %19), !dbg !61
  %23 = call i253 @"fib_box::fib_box::fib"(i253 %20, i253 %21, i253 %22), !dbg !61
  %24 = call i253 @"rename<Box<felt>>"(i253 %23), !dbg !61
  br label %dest3, !dbg !61

dest3:                                            ; preds = %dest1
  %25 = call i253 @"rename<Box<felt>>"(i253 %24), !dbg !61
  ret i253 %25, !dbg !61
}

define void @print_return(i253 %0) !dbg !62 {
entry:
  %rounded_size_val = zext i253 %0 to i256, !dbg !63
  %shifted = lshr i256 %rounded_size_val, 224, !dbg !63
  %print_value_trunc = trunc i256 %shifted to i32, !dbg !63
  %format = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format, align 1, !dbg !63
  %chars_printed = call i32 (ptr, ...) @printf(ptr %format, i32 %print_value_trunc), !dbg !63
  %shifted1 = lshr i256 %rounded_size_val, 192, !dbg !63
  %print_value_trunc2 = trunc i256 %shifted1 to i32, !dbg !63
  %format3 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format3, align 1, !dbg !63
  %chars_printed4 = call i32 (ptr, ...) @printf(ptr %format3, i32 %print_value_trunc2), !dbg !63
  %shifted5 = lshr i256 %rounded_size_val, 160, !dbg !63
  %print_value_trunc6 = trunc i256 %shifted5 to i32, !dbg !63
  %format7 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format7, align 1, !dbg !63
  %chars_printed8 = call i32 (ptr, ...) @printf(ptr %format7, i32 %print_value_trunc6), !dbg !63
  %shifted9 = lshr i256 %rounded_size_val, 128, !dbg !63
  %print_value_trunc10 = trunc i256 %shifted9 to i32, !dbg !63
  %format11 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format11, align 1, !dbg !63
  %chars_printed12 = call i32 (ptr, ...) @printf(ptr %format11, i32 %print_value_trunc10), !dbg !63
  %shifted13 = lshr i256 %rounded_size_val, 96, !dbg !63
  %print_value_trunc14 = trunc i256 %shifted13 to i32, !dbg !63
  %format15 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format15, align 1, !dbg !63
  %chars_printed16 = call i32 (ptr, ...) @printf(ptr %format15, i32 %print_value_trunc14), !dbg !63
  %shifted17 = lshr i256 %rounded_size_val, 64, !dbg !63
  %print_value_trunc18 = trunc i256 %shifted17 to i32, !dbg !63
  %format19 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format19, align 1, !dbg !63
  %chars_printed20 = call i32 (ptr, ...) @printf(ptr %format19, i32 %print_value_trunc18), !dbg !63
  %shifted21 = lshr i256 %rounded_size_val, 32, !dbg !63
  %print_value_trunc22 = trunc i256 %shifted21 to i32, !dbg !63
  %format23 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format23, align 1, !dbg !63
  %chars_printed24 = call i32 (ptr, ...) @printf(ptr %format23, i32 %print_value_trunc22), !dbg !63
  %shifted25 = lshr i256 %rounded_size_val, 0, !dbg !63
  %print_value_trunc26 = trunc i256 %shifted25 to i32, !dbg !63
  %format27 = alloca [5 x i8], align 1, !dbg !63
  store [5 x i8] c"%08X\00", ptr %format27, align 1, !dbg !63
  %chars_printed28 = call i32 (ptr, ...) @printf(ptr %format27, i32 %print_value_trunc26), !dbg !63
  %format29 = alloca [2 x i8], align 1, !dbg !63
  store [2 x i8] c"\0A\00", ptr %format29, align 1, !dbg !63
  %chars_printed30 = call i32 (ptr, ...) @printf(ptr %format29), !dbg !63
  ret void, !dbg !63
}

define i32 @main() !dbg !64 {
entry:
  %0 = call i253 @"felt_const<0>"(), !dbg !65
  %1 = call i253 @"store_temp<felt>"(i253 %0), !dbg !65
  %2 = call i253 @"into_box<felt>"(i253 %1), !dbg !65
  %3 = call i253 @"felt_const<1>"(), !dbg !65
  %4 = call i253 @"store_temp<felt>"(i253 %3), !dbg !65
  %5 = call i253 @"into_box<felt>"(i253 %4), !dbg !65
  %6 = call i253 @"felt_const<30>"(), !dbg !65
  %7 = call i253 @"store_temp<felt>"(i253 %6), !dbg !65
  %8 = call i253 @"into_box<felt>"(i253 %7), !dbg !65
  %9 = call i253 @"store_temp<Box<felt>>"(i253 %2), !dbg !65
  %10 = call i253 @"store_temp<Box<felt>>"(i253 %5), !dbg !65
  %11 = call i253 @"store_temp<Box<felt>>"(i253 %8), !dbg !65
  %12 = call i253 @"fib_box::fib_box::fib"(i253 %9, i253 %10, i253 %11), !dbg !65
  %13 = call i253 @"unbox<felt>"(i253 %12), !dbg !65
  %14 = call i253 @"store_temp<felt>"(i253 %13), !dbg !65
  %ret_struct_ptr = alloca { i253 }, align 8, !dbg !65
  %field_0_ptr = getelementptr inbounds { i253 }, ptr %ret_struct_ptr, i32 0, i32 0, !dbg !65
  store i253 %14, ptr %field_0_ptr, align 4, !dbg !65
  %return_struct_value = load { i253 }, ptr %ret_struct_ptr, align 4, !dbg !65
  %return_value_ptr = getelementptr inbounds { i253 }, ptr %ret_struct_ptr, i32 0, i32 0, !dbg !65
  %return_value = load i253, ptr %return_value_ptr, align 4, !dbg !65
  %format = alloca [15 x i8], align 1, !dbg !65
  store [15 x i8] c"Return value: \00", ptr %format, align 1, !dbg !65
  %chars_printed = call i32 (ptr, ...) @printf(ptr %format), !dbg !65
  call void @print_return(i253 %return_value), !dbg !65
  ret i32 0, !dbg !65
}
...
!2 = !DIFile(filename: "sierra/fib_box_main.sierra", directory: "sierra")
...
!54 = distinct !DISubprogram(name: "felt_const<0>", linkageName: "felt_const<0>", scope: null, file: !2, line: 23, type: !48, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!55 = !DILocation(line: 23, scope: !54)
!56 = distinct !DISubprogram(name: "felt_const<30>", linkageName: "felt_const<30>", scope: null, file: !2, line: 24, type: !48, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!57 = !DILocation(line: 24, scope: !56)
!58 = distinct !DISubprogram(name: "fib_box::fib_box::fib", linkageName: "fib_box::fib_box::fib", scope: null, file: !2, line: 25, type: !59, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!59 = !DISubroutineType(flags: DIFlagPublic, types: !60)
!60 = !{!33, !33, !33, !33}
!61 = !DILocation(line: 25, scope: !58)
!62 = distinct !DISubprogram(name: "print_return", linkageName: "print_return", scope: null, file: !2, line: 26, type: !4, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!63 = !DILocation(line: 26, scope: !62)
!64 = distinct !DISubprogram(name: "fib_box::fib_box::main", linkageName: "fib_box::fib_box::main", scope: null, file: !2, line: 26, type: !48, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!65 = !DILocation(line: 26, scope: !64)
