...
define i253 @"felt_const<30>"() !dbg !30 {
entry:
  ret i253 30, !dbg !31
}
...
entry:
  %3 = call i253 @"unbox<felt>"(i253 %2), !dbg !31
  %4 = call i253 @"store_temp<felt>"(i253 %3), !dbg !31
  %5 = call { i253, i253 } @"dup<felt>"(i253 %4), !dbg !31
  %res_ptr = alloca { i253, i253 }, align 8, !dbg !31
  store { i253, i253 } %5, ptr %res_ptr, align 4, !dbg !31
  %"3_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr, i32 0, i32 0, !dbg !31
  %"3" = load i253, ptr %"3_ptr", align 4, !dbg !31
  %"5_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr, i32 0, i32 1, !dbg !31
  %"5" = load i253, ptr %"5_ptr", align 4, !dbg !31
  %check = icmp eq i253 %"5", 0, !dbg !31
  br i1 %check, label %then, label %else, !dbg !31

then:                                             ; preds = %entry
  %6 = call i253 @"store_temp<Box<felt>>"(i253 %0), !dbg !31
  br label %dest, !dbg !31

else:                                             ; preds = %entry
  br label %dest1, !dbg !31

dest:                                             ; preds = %then
  %7 = call i253 @"rename<Box<felt>>"(i253 %6), !dbg !31
  %ret_struct_ptr = alloca { i253 }, align 8, !dbg !31
  %field_0_ptr = getelementptr inbounds { i253 }, ptr %ret_struct_ptr, i32 0, i32 0, !dbg !31
  store i253 %7, ptr %field_0_ptr, align 4, !dbg !31
  %return_struct_value = load { i253 }, ptr %ret_struct_ptr, align 4, !dbg !31
  ret { i253 } %return_struct_value, !dbg !31

dest1:                                            ; preds = %else
  %8 = call i253 @"unbox<felt>"(i253 %0), !dbg !31
  %9 = call { i253, i253 } @"dup<Box<felt>>"(i253 %1), !dbg !31
  %res_ptr2 = alloca { i253, i253 }, align 8, !dbg !31
  store { i253, i253 } %9, ptr %res_ptr2, align 4, !dbg !31
  %"1_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr2, i32 0, i32 0, !dbg !31
  %"1" = load i253, ptr %"1_ptr", align 4, !dbg !31
  %"9_ptr" = getelementptr inbounds { i253, i253 }, ptr %res_ptr2, i32 0, i32 1, !dbg !31
  %"9" = load i253, ptr %"9_ptr", align 4, !dbg !31
  %10 = call i253 @"unbox<felt>"(i253 %"9"), !dbg !31
  %11 = call i253 @"store_temp<felt>"(i253 %8), !dbg !31
  %12 = call i253 @"store_temp<felt>"(i253 %10), !dbg !31
  %13 = call i253 @felt_add(i253 %11, i253 %12), !dbg !31
  %14 = call i253 @"store_temp<felt>"(i253 %13), !dbg !31
  %15 = call i253 @"into_box<felt>"(i253 %14), !dbg !31
  %16 = call i253 @"felt_const<1>"(), !dbg !31
  %17 = call i253 @felt_sub(i253 %"3", i253 %16), !dbg !31
  %18 = call i253 @"store_temp<felt>"(i253 %17), !dbg !31
  %19 = call i253 @"into_box<felt>"(i253 %18), !dbg !31
  %20 = call i253 @"store_temp<Box<felt>>"(i253 %"1"), !dbg !31
  %21 = call i253 @"store_temp<Box<felt>>"(i253 %15), !dbg !31
  %22 = call i253 @"store_temp<Box<felt>>"(i253 %19), !dbg !31
  %23 = call { i253 } @"fib_box::fib_box::fib"(i253 %20, i253 %21, i253 %22), !dbg !31
  %res_ptr3 = alloca { i253 }, align 8, !dbg !31
  store { i253 } %23, ptr %res_ptr3, align 4, !dbg !31
  %"15_ptr" = getelementptr inbounds { i253 }, ptr %res_ptr3, i32 0, i32 0, !dbg !31
  %"15" = load i253, ptr %"15_ptr", align 4, !dbg !31
  %24 = call i253 @"rename<Box<felt>>"(i253 %"15"), !dbg !31
  br label %dest4, !dbg !31

dest4:                                            ; preds = %dest1
  %25 = call i253 @"rename<Box<felt>>"(i253 %24), !dbg !31
  %ret_struct_ptr5 = alloca { i253 }, align 8, !dbg !31
  %field_0_ptr6 = getelementptr inbounds { i253 }, ptr %ret_struct_ptr5, i32 0, i32 0, !dbg !31
  store i253 %25, ptr %field_0_ptr6, align 4, !dbg !31
  %return_struct_value7 = load { i253 }, ptr %ret_struct_ptr5, align 4, !dbg !31
  ret { i253 } %return_struct_value7, !dbg !31
}

define void @print_return(i253 %0) !dbg !32 {
entry:
  %rounded_size_val = zext i253 %0 to i256
  %shifted = lshr i256 %rounded_size_val, 224
  %print_value_trunc = trunc i256 %shifted to i32
...
define i32 @main() {
entry:
  %0 = call i253 @"felt_const<0>"(), !dbg !33
  %1 = call i253 @"store_temp<felt>"(i253 %0), !dbg !33
  %2 = call i253 @"into_box<felt>"(i253 %1), !dbg !33
  %3 = call i253 @"felt_const<1>"(), !dbg !33
  %4 = call i253 @"store_temp<felt>"(i253 %3), !dbg !33
  %5 = call i253 @"into_box<felt>"(i253 %4), !dbg !33
  %6 = call i253 @"felt_const<30>"(), !dbg !33
  %7 = call i253 @"store_temp<felt>"(i253 %6), !dbg !33
  %8 = call i253 @"into_box<felt>"(i253 %7), !dbg !33
  %9 = call i253 @"store_temp<Box<felt>>"(i253 %2), !dbg !33
  %10 = call i253 @"store_temp<Box<felt>>"(i253 %5), !dbg !33
  %11 = call i253 @"store_temp<Box<felt>>"(i253 %8), !dbg !33
  %12 = call { i253 } @"fib_box::fib_box::fib"(i253 %9, i253 %10, i253 %11), !dbg !33
  %res_ptr = alloca { i253 }, align 8, !dbg !33
  store { i253 } %12, ptr %res_ptr, align 4, !dbg !33
  %"6_ptr" = getelementptr inbounds { i253 }, ptr %res_ptr, i32 0, i32 0, !dbg !33
  %"6" = load i253, ptr %"6_ptr", align 4, !dbg !33
  %13 = call i253 @"unbox<felt>"(i253 %"6"), !dbg !33
  %14 = call i253 @"store_temp<felt>"(i253 %13), !dbg !33
  %ret_struct_ptr = alloca { i253 }, align 8, !dbg !33
  %field_0_ptr = getelementptr inbounds { i253 }, ptr %ret_struct_ptr, i32 0, i32 0, !dbg !33
  store i253 %14, ptr %field_0_ptr, align 4, !dbg !33
  %return_struct_value = load { i253 }, ptr %ret_struct_ptr, align 4, !dbg !33
  %return_value_ptr = getelementptr inbounds { i253 }, ptr %ret_struct_ptr, i32 0, i32 0, !dbg !33
  %return_value = load i253, ptr %return_value_ptr, align 4, !dbg !33
  %format = alloca [15 x i8], align 1, !dbg !33
  store [15 x i8] c"Return value: \00", ptr %format, align 1, !dbg !33
  %chars_printed = call i32 (ptr, ...) @printf(ptr %format), !dbg !33
  call void @print_return(i253 %return_value), !dbg !33
  ret i32 0, !dbg !33
}
...
!28 = distinct !DISubprogram(name: "felt_const<0>", linkageName: "felt_const<0>", scope: null, file: !2, line: 23, type: !23, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!29 = !DILocation(line: 23, scope: !28)
!30 = distinct !DISubprogram(name: "felt_const<30>", linkageName: "felt_const<30>", scope: null, file: !2, line: 24, type: !23, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!31 = !DILocation(line: 24, scope: !30)
!32 = distinct !DISubprogram(name: "print_return", linkageName: "print_return", scope: null, file: !2, line: 27, type: !4, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !7)
!33 = !DILocation(line: 27, scope: !32)
